...
#ifdef WIN32
    #include <windows.h>
//  #define DECODER_LIB TEXT( "G:\\MY-WORK\\NiuTransServer.Decoder\\Decoder\\x64\\Release\\DecoderLib.dll" )
    #define DECODER_LIB TEXT( "D:\\Decoder\\x64\\Release\\DecoderLib.dll" )
#else
    #include <dlfcn.h>
    #define DECODER_LIB "libDecoderLib.so"
#endif

typedef void* (*__pInit   )( const char* );

#ifndef WITHOUT_TRANSLATION_MEMORY_
typedef char* (*__pDo_job )( void*, const char*  );
#else
...
#ifndef WITHOUT_TRANSLATION_MEMORY_
        char * output = __do_job( class_handle, sentence.c_str() );
#else
